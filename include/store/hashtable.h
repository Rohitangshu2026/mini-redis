...
// Intrusive node — embed one in your own struct and recover the owner with
// container_of (any member offset works; keeping it first is just layout
// convention). The cached hash lets chains skip full key compares.
struct HNode{
    HNode*   next  = nullptr;
